<template>
  <div class="overview">
    ...
    <ft-card title="技术栈">
      <ft-text-link :text-arrs="technologyStacks" />
      <ft-descriptions title="生产环境依赖" :column="2" :table-datas="dependencies" />
      <ft-descriptions title="开发环境依赖" :column="2" :table-datas="devDependencies" />
    </ft-card>
    <ft-card title="项目结构">
      <div class="c-left">
        <ft-code language="bash" :code="projectDir" />
      </div>
    </ft-card>
    <ft-card title="项目规范">
      <ft-descriptions
...
import ftDescriptions from '@/base-ui/descriptions'
import ftTextLink from '@/base-ui/text-link'
import ftCode from '@/base-ui/code'
